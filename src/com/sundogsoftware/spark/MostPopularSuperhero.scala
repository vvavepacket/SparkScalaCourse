...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("/Users/ivanmatala/Downloads/SparkScala3/marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
    
    // Load up the superhero co-appearance data
    val lines = sc.textFile("/Users/ivanmatala/Downloads/SparkScala3/marvel-graph.txt")
